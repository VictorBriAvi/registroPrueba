          ...
          <div className="col-md-12">
            ...
            <div className="boton">
              <div className="container my-2">
                <Link
                  to={`/registrosPrueba/gastos/TiposDeGastos/Agregar-TipoDeGasto`}
                >
              ...
              <div className="container my-2">
                <Link to={"/registrosPrueba/gastos"}>
            ...
            <DataTable
              ...
              editUrl="/registrosPrueba/gastos/TiposDeGastos/editar-tipoDeGasto"
            />
            {/**
